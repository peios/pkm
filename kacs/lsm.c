...
static struct security_hook_list pkm_hooks[] __ro_after_init = {
	...
	LSM_HOOK_INIT(path_notify, pkm_kacs_path_notify),
	...
	LSM_HOOK_INIT(sk_clone_security, pkm_kacs_sk_clone_security),
	LSM_HOOK_INIT(socket_post_create, pkm_kacs_socket_post_create),
	LSM_HOOK_INIT(socket_bind, pkm_kacs_socket_bind),
	LSM_HOOK_INIT(socket_connect, pkm_kacs_socket_connect),
