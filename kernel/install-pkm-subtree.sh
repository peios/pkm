...
require_file "$src_root/lcs/source_device.h"
require_file "$src_root/lcs/kunit.c"
require_file "$src_root/lcs/rust_ingress.rs"
...
require_file "$src_root/uapi/pkm/lcs.h"
...
install -m 0644 "$src_root/lcs/source_device.h" "$pkm_dir/lcs/source_device.h"
install -m 0644 "$src_root/lcs/kunit.c" "$pkm_dir/lcs/kunit.c"
install -m 0644 "$src_root/lcs/rust_ingress.rs" "$pkm_dir/lcs/rust_ingress.rs"
...
install -m 0644 "$src_root/uapi/pkm/lcs.h" "$uapi_dir/lcs.h"
