...
static ssize_t pkm_lcs_kunit_delete_value_ioctl_source_read(
	struct pkm_lcs_kunit_delete_value_ioctl_source_script *script,
	u8 *request, size_t request_len)
{
	ssize_t count;
...
static int pkm_lcs_kunit_delete_value_ioctl_source_write_status(
	struct pkm_lcs_kunit_delete_value_ioctl_source_script *script,
	u64 request_id, u16 request_op, u32 status)
{
	u8 response[RSI_MIN_RESPONSE_SIZE];
...
static int pkm_lcs_kunit_delete_value_ioctl_source_write_query_response(
	struct pkm_lcs_kunit_delete_value_ioctl_source_script *script,
...
static int pkm_lcs_kunit_delete_value_ioctl_source_handle_query(
	struct pkm_lcs_kunit_delete_value_ioctl_source_script *script,
...
static int pkm_lcs_kunit_delete_value_ioctl_source_handle_delete(
	struct pkm_lcs_kunit_delete_value_ioctl_source_script *script,
...
static int pkm_lcs_kunit_delete_value_ioctl_source_handle_write_key(
	struct pkm_lcs_kunit_delete_value_ioctl_source_script *script,
	u8 *request, size_t request_len)
{
	size_t offset = RSI_REQUEST_HEADER_SIZE;
...
static struct kunit_case pkm_lcs_kunit_cases[] = {
	...
	KUNIT_CASE(
		pkm_lcs_kunit_key_fd_delete_key_transactional_source_failure),
	...
	KUNIT_CASE(
		pkm_lcs_kunit_transaction_log_key_path_records_context),
	...
	KUNIT_CASE(
		pkm_lcs_kunit_source_dispatch_hide_delete_entry_frames),
	KUNIT_CASE(
		pkm_lcs_kunit_source_hide_delete_entry_round_trip_statuses),
	...
	KUNIT_CASE(
		pkm_lcs_kunit_source_dispatch_delete_value_entry_frame),
	KUNIT_CASE(
		pkm_lcs_kunit_source_delete_value_entry_round_trip_statuses),
	KUNIT_CASE(
		pkm_lcs_kunit_source_dispatch_set_blanket_tombstone_frame),
	KUNIT_CASE(
		pkm_lcs_kunit_source_set_blanket_tombstone_round_trip_statuses),
	...
	KUNIT_CASE(
		pkm_lcs_kunit_source_dispatch_set_blanket_tombstone_rejects_bad_inputs),
	KUNIT_CASE(
		pkm_lcs_kunit_source_dispatch_path_entry_rejects_bad_inputs),
	KUNIT_CASE(
