...
#define KACS_SD_DACL_TRUSTED		0x0040U
#define KACS_SD_SERVER_SECURITY		0x0080U
#define KACS_SD_DACL_AUTO_INHERIT_REQ	0x0100U
#define KACS_SD_SACL_AUTO_INHERIT_REQ	0x0200U
