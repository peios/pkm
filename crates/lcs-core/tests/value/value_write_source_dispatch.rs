...
use lcs_core::{
    Guid, LcsError, REG_BINARY, REG_DWORD, REG_TOMBSTONE, RSI_REQUEST_HEADER_LEN, RSI_SET_VALUE,
    SequenceCounter, ValueWriteInput, parse_rsi_request_header,
    parse_rsi_set_value_request_payload, plan_value_write,
