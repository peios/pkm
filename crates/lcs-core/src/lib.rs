...
pub use rsi::{
    ...
    RsiEnumChildrenRequestPayload, RsiHideEntryRequestPayload, RsiLateResponseRecordPlan,
    ...
    RsiTransactionBeginStatusPlan, RsiTransactionBeginUse, RsiValidatedResponse,
    RsiWriteKeyRequestPayload, classify_rsi_status_code, map_rsi_status,
    parse_rsi_create_entry_request_payload, parse_rsi_create_key_request_payload,
    parse_rsi_delete_entry_request_payload, parse_rsi_delete_value_entry_request_payload,
