...
pub use backup::{
    ...
    BackupRestorePathEntry, BackupRestoreRootWritePlan, BackupRestoreSequenceRemapper,
    BackupRestoreTargetRoot, BackupRestoreValue, BackupStreamEnvelopeState,
    ...
    plan_backup_restore_root_write, remap_backup_restore_blanket_tombstone,
    remap_backup_restore_guid, remap_backup_restore_path_entry,
    remap_backup_restore_path_entry_for_dispatch, remap_backup_restore_value,
