...
pub use backup::{
    ...
    BackupRecordFrame, BackupRecordHeader, BackupRecordKind, BackupRestoreKeySetSummary,
    BackupRestorePathEntry, BackupRestoreTargetRoot, BackupStreamEnvelopeState,
    ...
    parse_backup_value_record, remap_backup_restore_guid, remap_backup_restore_path_entry,
