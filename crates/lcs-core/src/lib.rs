...
pub use rsi::{
    RsiCreateEntryRequestPayload, RsiDeleteEntryRequestPayload, RsiDispatchedWaitPlan,
    ...
    parse_rsi_lookup_request_payload, parse_rsi_request_header, parse_rsi_response_header,
    parse_rsi_status, plan_rsi_dispatched_wait, plan_rsi_late_response_record,
    plan_rsi_malformed_source_data, plan_rsi_slot_reservation, plan_rsi_source_poll,
