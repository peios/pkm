...
pub use rsi::{
    ...
    RsiReadKeyRequestPayload, RsiReadPlan, RsiRequestHeader, RsiRequestId, RsiRequestIdCounter,
    RsiResponseHeader, RsiRetainedRequest, RsiSlotReservationPlan, RsiSourceDataValidationFailure,
    RsiStatus, RsiStatusOutcome, RsiTrailingOptionalFieldsPlan, RsiTransactionBeginStatusPlan,
    RsiTransactionBeginUse, RsiValidatedResponse, RsiWriteKeyRequestPayload,
    classify_rsi_status_code, map_rsi_status, parse_rsi_create_entry_request_payload,
