...
pub use backup::{
    ...
    BackupRestoreTargetRoot, BackupStreamEnvelopeState, BackupStreamEnvelopeSummary,
    ...
    parse_backup_value_record, remap_backup_restore_guid, validate_backup_layer_manifest_set,
