...
pub use backup::{
    ...
    BackupRestorePathEntry, BackupRestoreSequenceRemapper, BackupRestoreTargetRoot,
    BackupStreamEnvelopeState, BackupStreamEnvelopeSummary, BackupTrailerPayload,
