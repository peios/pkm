...
pub use rsi::{
    ...
    RsiTransactionReplaySnapshotParsedResponse, RsiTransactionReplaySnapshotRequestRecord,
    RsiTransactionReplaySnapshotRequestTableSummary, RsiTransactionReplaySnapshotResponseMatch,
