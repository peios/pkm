...
pub use rsi::{
    ...
    RsiDeleteEntryRequestPayload, RsiDeleteLayerRequestPayload, RsiDeleteValueEntryRequestPayload,
    RsiDispatchedWaitPlan, RsiDropKeyRequestPayload, RsiEnumChildrenRequestPayload,
    RsiFlushRequestPayload, RsiHideEntryRequestPayload, RsiLateResponseRecordPlan,
    RsiLateResponseRecordState, RsiLengthPrefixedField, RsiLookupRequestPayload,
    RsiMalformedProtocolReason, RsiMalformedSourceDataPlan, RsiMappedErrno, RsiPayloadCursor,
    RsiPollPlan, RsiQueryValuesRequestPayload, RsiReadKeyRequestPayload, RsiReadPlan,
    RsiRequestHeader, RsiRequestId, RsiRequestIdCounter, RsiResponseHeader, RsiRetainedRequest,
    ...
    parse_rsi_read_key_request_payload, parse_rsi_request_header, parse_rsi_response_header,
