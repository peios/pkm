...
use peios_uapi::sys::syscall6;
use peios_uapi::syscall::{AT_FDCWD, SYS_KACS_GET_SD, SYS_KACS_SET_SD};
...
/// `AT_FDCWD` — dirfd value meaning "current working directory".
pub const FDCWD: i32 = AT_FDCWD;
